...
import BossDamageReport from "./BossDamageReport";
...
type Props = {
  ...
  hasReview: boolean;
  isBossMode?: boolean;
  bossDamageLog?: BossDamageLogEntry[];
  onBackToReview: () => void;
  onFightAgain: () => void;
  onGenerateDeck: () => void;
...
export default function ScorecardOverlay({ scorecard, isPartial, health, questionsSurvived, rounds, personalityName, hasReview, isBossMode, bossDamageLog, onBackToReview, onFightAgain, onGenerateDeck, isGeneratingDeck }: Props) {
  ...
  return (
    ...
    >
      ...
      {isBossMode && bossDamageLog && <BossDamageReport damageLog={bossDamageLog} />}
