...
// Pokemon-trading-card-styled business card: holographic border, gradient art, stats, moves, weakness, rarity
export default function PokemonCard({ card, accent = "#8b5cf6" }: Props) {
  return (
    <motion.div
      className={`w-64 shrink-0 rounded-2xl p-1 shadow-2xl ${RARITY_GLOW[card.rarity] ?? RARITY_GLOW.Common}`}
