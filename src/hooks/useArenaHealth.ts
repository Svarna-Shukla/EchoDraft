...
// "neutral" is intentionally mildly positive, not punishing: the round prompt's own rubric expects
// most real founders to land in the 4-7 (neutral) score band, so treating that band as a health loss
// meant the bar drained on almost every answer regardless of how the founder actually did
const DELTAS: Record<AnswerTier, number> = { strong: 8, neutral: 2, weak: -18, timeout: -25 };
